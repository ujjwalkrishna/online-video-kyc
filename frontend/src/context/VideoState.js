...
// const SERVER_URL = "https://kyc-verification-tvs.herokuapp.com/api";

const SERVER_URL = process.env.REACT_APP_API_URL;
//const SERVER_URL = "https://fathomless-tundra-67025.herokuapp.com";
...
const VideoState = ({ children }) => {
  ...
  const callAgent = (id) => {
    ...
    socket.emit("findFreeAgent", {
      from: me,
    });

    socket.on("foundFreeAgent", ({ agentId }) => {
      if (agentId)
        setOtherUser(agentId);
    })
